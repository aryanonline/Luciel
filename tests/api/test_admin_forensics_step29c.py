...
# ---- Step 29 Commit C.6/D paths (verification harness) -------------------
# REMOVED in Arc 5 Path A Commit B6: the entire app/verification/ V1 step26
# suite and tests/verification/ pytest harness were deleted as part of the
# Admin->Instance hierarchy collapse. The C.6 and D shape-guard tests that
# pinned the suite's internal structure (_infra_probes, registry, harness)
# are removed below; a V2 verification suite will be authored fresh post-
# Arc 5 (Phase 6 E2E replay).
