...
**Version:** v1.8
**Last updated:** 2026-05-05 ~10:53 EDT (P3-S Half 2 Step 5 GREEN — Commit 4 worker DB role swap COMPLETE). After Commit `0cd87be` (pg_roles + SSM-presence rotation guard + 11-test smoke suite + recap v1.7) and Commit `65f8996` (`mint-td-rev3.json` with new image digest), the rev-3 cycle ran cleanly end-to-end:
