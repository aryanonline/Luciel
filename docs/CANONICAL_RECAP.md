...
| Billing | **30a** | Subscription billing — sign-up, payment, plan changes, cancellation — integrated with our company website. | A new individual customer can find Luciel on our website, sign up, pay, start using their Luciel, change plans, and cancel — all without anyone from our team being involved. | 📋 Planned (after 30b). Operationalises the billing surface for Q5 (Sarah-to-department upgrade) once the company-website checkout exists. Architecture: ARCHITECTURE §3.2.9 (integrations). |
