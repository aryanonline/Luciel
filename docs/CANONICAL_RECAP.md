...
| Frontend | **32** | Self-service for individual professionals — they spin up their own Luciels under their own scope, no operator involvement. | Sarah signs up, configures her own Luciel for her own client work, and starts getting value, without anyone from our team on the call. | 📋 Planned. Operationalises Q1 self-service onboarding leg; also the natural landing point for the rotation runbook needed by Q6 (cross-listed under Step 32). |
