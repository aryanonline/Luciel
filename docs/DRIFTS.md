...
**Status:** OPEN — process drift; widget-surface slice tracked against Step 30d (CI gate, not a code commit); broader-routes slice still needs a roadmap home
