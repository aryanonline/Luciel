"""Arc 9 C3.2c -- RLS policy on conversations (Wall 1 Layer 2).

Conversation grouping rows.
...
revision = "arc9_c3_2c_rls_conversations"
down_revision = "arc9_c3_2b_rls_memory_items"
branch_labels = None
depends_on = None
