...
class TenantOnboardRequest(BaseModel):
    ...
    (description, escalation_contact) are retained on the request for
    source-compat but are no longer persisted as Admin columns -- they
    thread into audit metadata only.
    """
