...
def _response(
    *, admin_id: str, admin_tier: str, instance: Instance
    ...
    # Single-login (Locked Dec #19): changes always apply immediately.
    # approval_state is always 'live'; no pending fields.
...
# Enterprise personality approval workflow (approve/reject routes) removed
# in Unit 1 excision (Locked Dec #19: single-login, no second admin).
