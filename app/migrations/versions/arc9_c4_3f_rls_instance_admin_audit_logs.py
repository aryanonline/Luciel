"""Arc 9 C4.3f -- Wall 3 RLS policy on admin_audit_logs (luciel_instance_id).
...
materialises Wall 3's Layer 2 (PostgreSQL RLS) on admin_audit_logs.
...
revision = "arc9_c4_3f_rls_instance_admin_audit_logs"
down_revision = "arc9_c4_3e_rls_instance_traces"
branch_labels = None
depends_on = None
