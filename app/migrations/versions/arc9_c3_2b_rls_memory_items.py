"""Arc 9 C3.2b -- RLS policy on memory_items (Wall 1 Layer 2).

Extracted user memory rows.
...
revision = "arc9_c3_2b_rls_memory_items"
down_revision = "arc9_c3_2a_rls_traces"
branch_labels = None
depends_on = None
