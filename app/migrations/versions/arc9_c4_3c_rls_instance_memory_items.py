"""Arc 9 C4.3c -- Wall 3 RLS policy on memory_items (luciel_instance_id).
...
materialises Wall 3's Layer 2 (PostgreSQL RLS) on memory_items.
...
revision = "arc9_c4_3c_rls_instance_memory_items"
down_revision = "arc9_c4_3b_rls_instance_knowledge_embeddings"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.execute(
        """
        CREATE POLICY memory_items_instance_isolation
        ON memory_items
        AS PERMISSIVE
        FOR ALL
        TO PUBLIC
